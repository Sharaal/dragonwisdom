...
- Zweckorientierte Sammelmodule sind erlaubt, wenn mehrere semantisch zusammengehörige HTML-Elemente dieselbe Standardformatierung teilen, z. B. `src/typography`, `src/links` und `src/lists`.
...
- `src/dragonwisdom.js` bleibt ein schlanker Entry und importiert nur Element-Module für Verhalten.
